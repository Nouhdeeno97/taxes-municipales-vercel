...
describe("préparation Vercel", () => {
  ...
  it("fournit une fonction Vercel dynamique avec une santé isolée et un backend regroupé", () => {
    ...
    expect(bundleVerifier).toContain('buildId !== "closing-agent-search-v13"');
    ...
    expect(bundleVerifier).toContain("zoneId, marketId: null, marketLocationId: null");
    expect(bundleVerifier).toContain("marketId, marketLocationId: null");
  });
